package com.rnmap_wb.activity.mapwork.db;
...
/**
 * 代码复制自{@link org.osmdroid.tileprovider.modules.MBTilesFileArchive }
 *
 * 去除 google tile spec 。
 *
	...
	public InputStream getInputStream(final ITileSource pTileSource, final long pMapTileIndex) {
		try {
			...
			final String[] xyz = {
					...
					,  Integer.toString(MapTileIndex.getY(pMapTileIndex))

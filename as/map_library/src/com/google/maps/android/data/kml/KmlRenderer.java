    ...
    private void addContainerGroupToMap(Iterable<KmlContainer> kmlContainers,
        ...
        for (KmlContainer container : kmlContainers) {
            ...
            if (container.hasContainers()) {
                ...
                {Log.e("TAG","======================"+container.hasPlacemarks());}
...
//            try {
//                String s=JSONObject.toJSONString(kmlContainer);
//
//
//                KmlContainer temp=   JSONObject.parseObject(s,KmlContainer.class);
//                Log.e("TAG","id:"+temp.getContainerId());
//            }catch (Throwable t)
//            {
//                t.printStackTrace();
//            }
    ...
    private void downloadMarkerIcons() {
        ...
        for (Iterator<String> iterator = getMarkerIconUrls().iterator(); iterator.hasNext(); ) {
            ...
            new MarkerIconImageDownload(markerIconUrl).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
            iterator.remove();
        }
    }
    ...
    private void scaleBitmap(KmlStyle style, HashMap<KmlPlacemark, Object> placemarks,
        ...
        Object o = placemarks.get(placemark);
        if(o instanceof  Marker)
        ((Marker) o).setIcon(scaledBitmap);
     }
    ...
    public void updateFeatures()
    {
        ...
        Log.e(LOG_TAG,"time use in add:"+(Calendar.getInstance().getTimeInMillis()-time));
    }
}

...
public class StringUtil {
    ...
    public static String toString(String divider, String... list) {


        StringBuilder mBuffer = new StringBuilder();
        for (String u : list) {
            mBuffer.append(u);
            mBuffer.append(divider);
        }
        if (mBuffer.length() > 0) {
            mBuffer.setLength(mBuffer.length() - divider.length());
        }
    ...
    public static String toString(String divider, List<String> list) {
...
//	public static List<String> toList(String divider,String temp) {
//
//
//
//

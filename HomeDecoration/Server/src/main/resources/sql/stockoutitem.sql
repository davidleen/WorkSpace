select B.ck_no,B.itm, B.PRD_NO ,b.id_no,b.os_no,b.bat_no,B.CUS_OS_NO,isnull(B.UP,0) as UP, isnull(PS.QTY,0) as  QTY, isnull(PS.AMT,0) as   AMT , isnull(TPS.SA_BYXS,0) as SO_ZXS,A.IDX_NAME,A.XS,A.KHXG,A.XGTJ,TPS.SA_BYTJ as ZXGTJ,isnull(A.JZ1,0)as JZ1,isnull(A.MZ,0) as MZ ,A.HPGG ,isnull(c.rem,'') as hsCode , isnull(m.jmcc,'') as jmcc ,PSZ.xhfq as fengqianhao , PSZ.xhgh as guihao,PSZ.xhgx as guixing,PS.ps_no as ps_no   from

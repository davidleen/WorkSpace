...
public class OrderReportItemTableModel extends BaseTableModel<OrderReportItem> {
    ...
    public static String[] columnNames = new String[]{"客户", "合同号 ", "货号", "图片", "客号", "单位", "数量", "验货日期", "出柜日期", "业务员","在产状态","颜色加工户","包装加工户","备注"};
    public static int[] columnWidth = new int[]{80, 100, 80, ImageUtils.MAX_PRODUCT_MINIATURE_WIDTH, 80, 60, 60, 100, 100, 80,100,100,100,200};


    public static String[] fieldName = new String[]{"cus_no", "os_no", "prd_no", "thumbnail", "cus_prd_no", "unit", "qty", "verifyDate", "sendDate", "saleName","workState","workerD","workerC","memo"};

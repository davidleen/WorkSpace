...
//                .showImageOnFail(R.mipmap.icon_image_lost).showImageOnLoading(R.mipmap.icon_image_loading)
...
//                            }
    ...
    @Override
    public void displayImage(String url, int res, ImageView imageView) {
        imageLoader.displayImage(url,imageView);
    }

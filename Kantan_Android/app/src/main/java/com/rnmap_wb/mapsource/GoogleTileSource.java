package com.rnmap_wb.mapsource;
...
public class GoogleTileSource extends TileSourceFactory {
    ...
    public static final OnlineTileSourceBase GoogleHybrid = new XYTileSource("Google-Hybrid",
        ...
        public String getTileURLString(long pMapTileIndex) {
            Log.d(TAG, getBaseUrl() + "/vt/lyrs=y&scale=2&hl=zh-CN&gl=CN&src=app&x=" + MapTileIndex.getX(pMapTileIndex) + "&y=" + MapTileIndex.getY(pMapTileIndex) + "&z=" + MapTileIndex.getZoom(pMapTileIndex));
